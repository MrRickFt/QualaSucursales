...
export class ProductoComponent implements OnInit {
  ...
  constructor(private sucursalService: SucursalService,
    ...
    private monedaService: MonedaService) {
      const referenciaParam = this.aRoute.snapshot.paramMap.get('referencia');
     this.referencia = referenciaParam ? parseInt(referenciaParam) : 0; // O cualquier valor por defecto que desees
